...
export const BRAND = {
  ...
  /**
   * رقم البوت على واتساب — E.164 بلا «+»، لروابط wa.me.
   *
   * وهو **غير** `phoneDisplay`: ذاك خطّ المحل الذي يردّ عليه موظّف، وهذا خطٌّ
   * مسجَّلٌ في واجهة واتساب للأعمال يردّ عليه النظام. وخروجه من التطبيق شرطُ
   * التسجيل نفسه، فلا يصحّ أن يكون الخطّين واحداً.
   */
  whatsapp: "9647810016016",

  /**
   * بطاقة المطعم على خرائط جوجل — الرابط القصير الذي يملكه المالك.
   *
   * وهو أهمّ رابطٍ في الموقع كلّه لبحثٍ محلّي: من يبحث عن مطعمٍ في الرمادي
   * يرى الخريطة قبل الموقع، وربطُ الاثنين يقول لجوجل إن هذه الصفحة وتلك
   * البطاقة شيءٌ واحد. وكان هنا بحثٌ عامّ (`?q=Station+Ramadi`) لا مكانٌ
   * بعينه — فيفتح قائمةً لا مطعماً.
   */
  mapsUrl: "https://maps.app.goo.gl/S74Jb6hnwuCAki548",
  /**
   * الرابط الذي يُرسَل للزبون ليكتب تقييمه.
   *
   * هو رابط البطاقة نفسه الذي أعطاه المالك — لا رابطٌ استنتجته أنا. ورابط
   * «اكتب تقييماً» المباشر يوفّر على الزبون ضغطتين، لكنه يُبنى من معرّفٍ
   * مستخرَج، وخطؤه يرسل الناس ليقيّموا مطعماً آخر. فالمضمون أولى.
   */
  reviewUrl: "https://maps.app.goo.gl/S74Jb6hnwuCAki548",
  /** إحداثيات المحل كما في بطاقته — تُرسَل في البيانات المنظَّمة */
  geo: { lat: 33.4158031, lng: 43.3016279 },
