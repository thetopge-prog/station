...
const ar: SiteCopy = {
  metaTitle: "ستيشن — أول مطعم تقني في الأنبار | كنتاكي وبرجر وبيتزا في الرمادي",
  metaDescription: "أول مطعم تقني في الأنبار — التقنية في كل ركنٍ منه، وطلبك من هاتفك يصل المطبخ في ثانية. كنتاكي مقرمش وبرجر وبيتزا في الرمادي — السبت–الخميس ٩ صباحاً حتى ٣ فجراً، والجمعة من ١ ظهراً.",
  ...
  ticker: ["دجاج مقرمش", "بيتزا بعجين يومي", "تسعة صوصات", "برجر لحم طازج", "توصيل ساخن", "من ٩ صباحاً لـ٣ فجراً · الجمعة من ١ ظهراً"],
  ...
  deliveryPoints: ["يُقلى عند الطلب لا قبله", "علب تحفظ الحرارة والقرمشة", "تتبّع طلبك برسالة واتساب", "اطلب من البيت، أو من سيارتك، أو من طاولتك — ونفس النظام"],
  faqTitle: "أسئلة يسألها الناس",
  faq: [
    { q: "شنو يعني «مطعم تقني»؟", a: "كل شيء في المحطة يمرّ على النظام: تطلب بنفسك من هاتفك، فيصل طلبك إلى شاشة المطبخ في ثانية، وتُطبع تذكرة التجهيز وحدها، ويخبرك واتساب حين يجهز. الطلب الذاتي والتوصيل الذكي متوفّران اليوم في فرعنا بالرمادي." },
    { q: "شلون أطلب من ستيشن؟", a: "بثلاث طرق وكلّها من هاتفك: من البيت فيوصلك الطلب للباب، أو من سيارتك فنسلّمك إياه دون نزول وتكدر تخبّرنا وين واقف، أو من طاولتك بمسح رمز الطاولة." },
    { q: "شنو أوقات الدوام؟", a: "من السبت إلى الخميس من ٩:٠٠ صباحاً حتى ٣:٠٠ فجراً، **ويوم الجمعة نفتح ١:٠٠ ظهراً** حتى ٣:٠٠ فجراً. والطلب من الموقع متاح طوال هذه الساعات." },
  ...
  tech: [
    ...
    { title: "الطلب الذاتي", body: "تطلب بنفسك من هاتفك: امسح رمز الطاولة، أو افتح رابط المنيو من البيت أو من سيارتك. لا انتظار، ولا وسيط، ولا خطأ في نقل الطلب." },
  ],
  ...
  hours: "ساعات العمل",
  hoursValue: "السبت–الخميس ٩:٠٠ صباحاً – ٣:٠٠ فجراً · الجمعة ١:٠٠ ظهراً – ٣:٠٠ فجراً",
  address: "العنوان",
  call: "اتصل بنا",
  whatsapp: "واتساب",
...
const en: SiteCopy = {
  ...
  deliveryPoints: ["Fried when you order, not before", "Boxes that hold heat and crunch", "Track it by WhatsApp message", "Order from home, from your car, or from your table — one system"],
  faqTitle: "What people ask",
  faq: [
    { q: "What does a «tech-run restaurant» mean?", a: "Everything at Station runs through the system: you order yourself from your phone, it reaches the kitchen screen in a second, the prep ticket prints on its own, and WhatsApp tells you when it is ready. Self-ordering and smart delivery are both live today at our Ramadi branch." },
    { q: "How do I order from Station?", a: "Three ways, all from your phone: from home and we bring it to your door, from your car and we hand it over without you stepping down — you can tell us where you parked — or from your table by scanning the table code." },
    { q: "What are your hours?", a: "Saturday to Thursday from 9:00 in the morning until 03:00 at night. **On Friday we open at 13:00** and close at 03:00. The website takes orders the whole time." },
  ...
  tech: [
    ...
    { title: "Self-ordering", body: "You order yourself from your phone: scan the table code, or open the menu link from home or from your car. No waiting, no middleman, nothing lost in the telling." },
  ],
  ...
  hours: "Opening hours",
  hoursValue: "Sat–Thu 9:00–03:00 · Friday 13:00–03:00",
  address: "Address",
  call: "Call us",
  whatsapp: "WhatsApp",
...
const tr: SiteCopy = {
  ...
  deliveryPoints: ["Sipariş verilince kızartılır", "Isıyı ve çıtırlığı koruyan kutular", "WhatsApp mesajıyla takip", "Evden, arabanızdan ya da masanızdan sipariş verin — tek sistem"],
  faqTitle: "Sık sorulanlar",
  faq: [
    { q: "«Teknoloji restoranı» ne demek?", a: "Station'da her şey sistemden geçer: siparişi telefonunuzdan kendiniz verirsiniz, bir saniyede mutfak ekranına düşer, hazırlık fişi kendiliğinden yazılır ve hazır olunca WhatsApp haber verir. Self sipariş ve akıllı teslimat bugün Ramadi şubemizde çalışıyor." },
    { q: "Station'dan nasıl sipariş veririm?", a: "Üç yolla, hepsi telefonunuzdan: evden verirsiniz kapınıza getiririz, arabanızdan verirsiniz inmeden elinize veririz — nerede park ettiğinizi yazabilirsiniz — ya da masanızdan masa kodunu okutarak." },
    { q: "Çalışma saatleriniz nedir?", a: "Cumartesiden perşembeye 09:00'dan gece 03:00'e kadar. **Cuma günü 13:00'te açılıyoruz**, kapanış yine 03:00. Site bu saatler boyunca sipariş alır." },
  ...
  tech: [
    ...
    { title: "Self sipariş", body: "Siparişi telefonunuzdan kendiniz verirsiniz: masa kodunu okutun ya da menü bağlantısını evden veya arabanızdan açın. Bekleme yok, aracı yok, yanlış aktarma yok." },
  ],
  ...
  hoursValue: "Cmt–Prş 09:00–03:00 · Cuma 13:00–03:00",
  address: "Adres",
  call: "Bizi arayın",
  whatsapp: "WhatsApp",
...
const it: SiteCopy = {
  ...
  deliveryPoints: ["Fritto quando ordini, non prima", "Scatole che tengono calore e croccantezza", "Lo segui con un messaggio WhatsApp", "Ordina da casa, dall'auto o dal tavolo — un solo sistema"],
  faqTitle: "Le domande più frequenti",
  faq: [
    { q: "Che cosa significa «ristorante tecnologico»?", a: "Da Station tutto passa dal sistema: ordini da solo dal telefono, l'ordine arriva allo schermo della cucina in un secondo, lo scontrino di preparazione si stampa da sé e WhatsApp ti avvisa quando è pronto. L'ordine self-service e la consegna intelligente sono attivi oggi nella sede di Ramadi." },
    { q: "Come ordino da Station?", a: "In tre modi, tutti dal telefono: da casa e te lo portiamo alla porta, dall'auto e te lo consegniamo senza scendere — puoi dirci dove hai parcheggiato — oppure dal tavolo scansionando il codice." },
    { q: "Quali sono gli orari?", a: "Dal sabato al giovedì dalle 9:00 alle 03:00. **Il venerdì apriamo alle 13:00** e chiudiamo alle 03:00. Il sito prende ordini per tutto questo tempo." },
  ...
  tech: [
    ...
    { title: "Ordine self-service", body: "Ordini da solo dal telefono: scansiona il codice del tavolo, o apri il link del menu da casa o dall'auto. Nessuna attesa, nessun intermediario, niente che si perde nel passaparola." },
  ],
  ...
  addressValue: "Al-Mustawda' St., Fursan Roundabout, Ramadi, Iraq",
  hours: "Orari",
  hoursValue: "Sab–Gio 9:00–03:00 · Venerdì 13:00–03:00",
  address: "Indirizzo",
  call: "Chiamaci",
  whatsapp: "WhatsApp",
...
const ku: SiteCopy = {
  ...
  deliveryPoints: ["کاتێک داوای دەکەیت دەبرژێنرێت، نەک پێشتر", "قوتووی پاراستنی گەرمی و تەنوکی", "بە نامەی واتساپ چاودێری بکە", "لە ماڵەوە، لە ئۆتۆمبێلەکەتەوە، یان لە مێزەکەتەوە داوا بکە — هەمان سیستەم"],
  faqTitle: "پرسیارە باوەکان",
  faq: [
    { q: "«چێشتخانەی تەکنەلۆژی» واتە چی؟", a: "لە ستەیشن هەموو شتێک بە سیستەمدا تێدەپەڕێت: خۆت لە مۆبایلەکەتەوە داوا دەکەیت، لە چرکەیەکدا دەگاتە شاشەی چێشتخانە، پسوولەی ئامادەکاری خۆی چاپ دەبێت، و واتساپ پێت دەڵێت کەی ئامادەیە. داواکاری خۆکار و گەیاندنی زیرەک ئەمڕۆ لە لقی ڕەمادی کاردەکەن." },
    { q: "چۆن لە ستەیشن داوا بکەم؟", a: "بە سێ ڕێگا، هەموویان لە مۆبایلەکەتەوە: لە ماڵەوە و بۆ بەردەرگاکەت دەیگەیەنین، لە ئۆتۆمبێلەکەتەوە و بێ دابەزین دەتدەینێ — دەتوانیت پێمان بڵێیت لەکوێ ڕاتگرتووە — یان لە مێزەکەتەوە بە خوێندنەوەی کۆدی مێزەکە." },
    { q: "کاتژمێری کارکردن چۆنە؟", a: "لە شەممەوە تا پێنجشەممە لە ٩:٠٠ی بەیانییەوە تا ٣:٠٠ی دواین شەو. **ڕۆژی هەینی لە ١:٠٠ی دوانیوەڕۆ دەکەینەوە** و لە ٣:٠٠ دادەخەین. ماڵپەڕەکەش بە درێژایی ئەو کاتە داواکاری وەردەگرێت." },
  ...
  tech: [
    ...
    { title: "داواکاری خۆکار", body: "خۆت لە مۆبایلەکەتەوە داوا دەکەیت: کۆدی مێزەکە بخوێنەوە، یان بەستەری خواردنەکان لە ماڵەوە یان لە ئۆتۆمبێلەکەتەوە بکەرەوە. چاوەڕوانی نییە، ناوبژیوان نییە، و هیچ شتێک لە گواستنەوەدا ون نابێت." },
  ],
  ...
  hoursValue: "شەممە–پێنجشەممە ٩:٠٠ – ٣:٠٠ · هەینی ١:٠٠ی دوانیوەڕۆ – ٣:٠٠",
  address: "ناونیشان",
