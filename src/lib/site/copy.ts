...
const ar: SiteCopy = {
  ...
  metaDescription: "أول مطعم تقني في الأنبار — التقنية في كل ركنٍ منه، وطلبك من هاتفك يصل المطبخ في ثانية. كنتاكي مقرمش وبرجر وبيتزا في الرمادي، من ٩ صباحاً حتى ٣ فجراً.",
