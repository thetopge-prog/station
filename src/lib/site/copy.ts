...
const ku: SiteCopy = {
  metaTitle: "ستیشن — یەکەم چێشتخانەی تەکنەلۆژی لە ئەنبار",
  ...
  about: [
    "ستیشن چێشتخانەیەکە لە ڕەمادی بە یەک بیرۆکە دەستی پێکرد: خواردنێک شایەنی چاوەڕوانی بێت، و کاتێک بە چاوەڕوانی بەفیڕۆ نەڕوات. مریشک لێرە تامدار دەکرێت و لە کاتی داواکاریدا دەبرژێنرێت، هەویر هەموو بەیانییەک دروست دەکرێت، و هەر نۆ سۆسەکە لە چێشتخانەی خۆماندا ئامادە دەکرێن.",
    "ناوەکەی خۆی دەیڵێت: وێستگەیەک کە لێی دەوەستیت، پێویستیت وەردەگریت و دەڕۆیت. داواکاری لە مێزەوە، لە ماڵەوە، یان لە ئۆتۆمبێلەکەت — هەمووی لەسەر هەمان سیستەم.",
  ],
  techTitle: "یەکەم چێشتخانەی تەکنەلۆژی لە ئەنبار",
  techLead: "شاشە بۆ ڕازاندنەوە نییە: هەرچی لێرەیە ئەمڕۆ کاردەکات و هەموو داواکارییەک پێیدا تێدەپەڕێت.",
  tech: [
    { title: "لە مێزەوە داوا بکە", body: "کۆدی مێزەکە بە کامێرای مۆبایلەکەت بخوێنەوە: مێنیو بە وێنە و نرخەوە دەکرێتەوە و داواکارییەکەت ڕاستەوخۆ دەنێردرێت." },
    { title: "چێشتخانە دەستبەجێ دەیبینێت", body: "هەر کە داواکاری پەسەند بکرێت لەسەر شاشەی چێشتخانە دەردەکەوێت و پسوولەی ئامادەکاری چاپ دەکرێت — هیچ کاغەزێک ون نابێت." },
    { title: "واتساپ ئاگادارت دەکاتەوە", body: "نامەیەک کاتێک داواکاریت وەردەگیرێت، یەکێکی تر کاتێک ئامادە دەبێت، و یەکێک کاتێک گەیەنەر وەریدەگرێت." },
    { title: "هەڵسەنگاندنت دەگاتە بەڕێوەبەرایەتی", body: "دوای گەیاندن سیستەمەکە پرسیارت لێدەکات دەربارەی خواردن و خزمەتگوزاری، وەڵامەکەت ڕاستەوخۆ دەگاتە بەڕێوەبەرایەتی." },
  ],
  qualityTitle: "بۆچی خەڵک دێنەوە",
  qualityLead: "ئەوەی لە وێنەدا نابینرێت، ئەوەیە کە تامەکە دروست دەکات.",
  quality: [
    { title: "زەیت بە خشتە دەگۆڕدرێت", body: "زەیتی برژاندنی باش بەکاردەهێنین و لە کاتی خۆیدا دەیگۆڕین، نەک کاتێک ڕەنگی خراپ دەبێت." },
    { title: "مریشکی تازە ڕۆژانە", body: "تازە دەگاتێ، لە چێشتخانەدا تامدار دەکرێت، و تەنها کاتێک داوای دەکەیت دەبرژێنرێت." },
    { title: "هەویر هەموو بەیانییەک", body: "هەویری پیتزا ڕۆژانە لە چێشتخانەکەماندا دروست دەکرێت، بە مۆزارێلای تەواو." },
    { title: "چێشتخانەی کراوە", body: "چێشتخانەکەمان دیارە: پاکوخاوێنی بەشێکە لە خزمەتگوزاری، نەک نهێنییەک لە پشت دەرگاوە." },
    { title: "پاکەتی پاراستنی برژاندن", body: "قوتووی هەناسەدەر — مریشک لە ڕێگادا نەرم نابێت." },
  ],
  menuTitle: "لە مێنیوەکە",
  menuLead: "مریشک، ستریپس، بەرگەر، پیتزا، ڕیزۆ، فرایز و سۆسەکانی ستیشن.",
  menuCta: "مێنیوی تەواو ببینە",
  franchiseTitle: "نوێنەرایەتی ستیشن — لقی خۆت بکەرەوە",
  franchiseLead:
    "ستیشن دەرگای خۆی بۆ هاوبەشان لە پارێزگاکانی عێراق دەکاتەوە: ناوەکە، ڕێسەتەکان، ڕاهێنان، و ئەو سیستەمەی هەموو چێشتخانەکە بەڕێوەدەبات — لە یەکەم داواکارییەوە تا ژماردنی کۆتایی شەو.",
  franchisePoints: [
    "ڕێسەتەکانمان و ڕاهێنانی تیمەکەت لە چێشتخانەکەماندا",
    "تەواوی سیستەمی ستیشن: کاشێر، چێشتخانە، گەیاندن، ڕاپۆرت",
    "ناسنامەی بازرگانی ئامادە و پشتگیری لە ئامادەکاری و کردنەوەدا",
  ],
  form: {
    name: "ناوت",
    city: "شار",
    ...
    notePlaceholder: "ئەزموونت، ئەو شوێنەی لە بیرتدایە…",
  ...
  visitTitle: "سەردانمان بکە یان پەیوەندی بکە",
  addressValue: "ڕەمادی، شەقامی مەخزەن، خولانەی فوورسان",
  hours: "کاتەکانی کارکردن",
  hoursValue: "هەموو ڕۆژێک لە ٩:٠٠ بەیانی تا ٣:٠٠ بەیانی",
  address: "ناونیشان",
