    ...
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <Section icon={<Smartphone className="size-5" />} title="٥ — جهاز توترز / طلباتي">
        ...
        <ol className="mt-3 list-inside list-decimal space-y-1 text-sm font-bold text-muted-foreground">
          <li>افتح <code dir="ltr">station.187.124.112.104.sslip.io/apk</code> من متصفح الجهاز ونصّبه (اسمح بـ«مصادر غير معروفة»).</li>
      ...
      {hubCommand && (
        <Section icon={<Server className="size-5" />} title="٧ — الهَب: العمل بلا إنترنت">
          ...
          <p className="mt-3 text-xs font-bold text-muted-foreground">
            ما يعمل بلا إنترنت: بيع الكاشير وطباعته، طلبات الزبائن (QR/كشك/التوصيل)، شاشات المطبخ والتجهيز والاستلام، الدخول لمن دخل من قبل
            (١٦ ساعة). لا يعمل: فتح وردية جديدة أو إغلاقها، الديون، التقارير — تحتاج الخط.
          </p>
        </Section>
      )}
