...
export default async function SetupPage() {
  ...
  const defs = [
    ...
    /*
     * جدار الإعلان — أربع شاشاتٍ متجاورة تعرض تصميماً واحداً.
     *
     * الرموز هنا لأن هذه العناوين تُفتح على تلفزيونٍ أو صندوق أندرويد
     * بريموت، وكتابة أربعة عناوين بلوحة مفاتيحٍ على الشاشة خطأٌ في انتظار
     * أن يقع. يُمسح الرمز فيُفتح العنوان الصحيح — وترتيبها من اليسار
     * إلى اليمين كما تُعلَّق.
     */
    { title: "الجدار ١ — أقصى اليسار", note: "شاشة الإعلان الأولى", path: "/wall/1" },
    { title: "الجدار ٢", note: "الثانية من اليسار", path: "/wall/2" },
    { title: "الجدار ٣", note: "الثالثة من اليسار", path: "/wall/3" },
    { title: "الجدار ٤ — أقصى اليمين", note: "شاشة الإعلان الرابعة", path: "/wall/4" },
    { title: "الجدار كاملاً", note: "للاطّلاع على شاشةٍ واحدة — لا يُعلَّق", path: "/wall/all" },
    { title: "فحص الجدار", note: "افتحها على التلفزيون، انتظر دقيقتين، وصوّرها", path: "/wall/check" },
  ];
